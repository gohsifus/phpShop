    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item">Карандаши</a>
                <a href="#" class="list-group-item">Телескопы</a>
                <a href="#" class="list-group-item">Телефоны</a>
            </div>
                ...
                <?php if (isset($goodsList)) {
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">
                                    <a href="/goods/all/<?php echo $item['id'];?>"><?php echo $item['name']?></a>
                                </h4>
